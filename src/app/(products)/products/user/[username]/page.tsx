...
import { getUserProfileByUsername, getUserProducts } from '@/features/products/user/api';
import { UserProfileHeader } from '@/features/products/user/components/UserProfileHeader';
